                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <form class="mx-1 mx-md-4" action="changepassword" method="post">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <p class="text-white-50 mb-5">Podaj stare, a następnie nowe hasło</p>

                                <div class="form-outline form-white mb-4">
                                    <input type="password" id="password" name="password" class="form-control form-control-lg" />
                                    <label class="form-label" for="password">Stare hasło</label>
                                </div>

                                <div class="form-outline form-white mb-4">
                                    <input type="password" id="password2" name="password2" class="form-control form-control-lg" />
                                    <label class="form-label" for="password2">Nowe hasło</label>
                                </div>
